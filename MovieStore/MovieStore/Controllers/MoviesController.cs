    ...
    public class MoviesController : Controller
    {
        ...
        public List<Movie> ListOfMovies() {
            List<Movie> movies = new List<Movie>() {
                new Movie{ MovieId = 1, Title = "King Pin", YearRelease= 1996},
                new Movie{ MovieId = 2, Title = "The Sound of Music", YearRelease=1965},
                new Movie{ MovieId = 3, Title = "E.T. The Extra Terrestrial", YearRelease=1982}
            };
            return movies;
        }
